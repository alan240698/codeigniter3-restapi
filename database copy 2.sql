...
(1, 'Network', 'NETWORK', 'Network related issues', 'fa-network-wired', '#3498db', 1, 'active'),
(2, 'HRM', 'HRM', 'Human Resource Management', 'fa-users', '#e74c3c', 2, 'active'),
(3, 'User Computer', 'USER_COMPUTER', 'Computer hardware and software', 'fa-desktop', '#2ecc71', 3, 'active'),
(4, 'Cyber Security', 'CYBER_SECURITY', 'Security related issues', 'fa-shield-alt', '#f39c12', 4, 'active');

-- Insert Ticket Types
INSERT INTO `it_ticket_types` (`id`, `name`, `code`, `description`, `icon`, `color`, `sort_order`, `status`) VALUES
(1, 'Incident', 'INCIDENT', 'Service disruption or degradation', 'fa-exclamation-triangle', '#e74c3c', 1, 'active'),
(2, 'Request', 'REQUEST', 'Service request', 'fa-hand-paper', '#3498db', 2, 'active'),
(3, 'Change', 'CHANGE', 'Change request', 'fa-exchange-alt', '#f39c12', 3, 'active'),
(4, 'Problem', 'PROBLEM', 'Root cause analysis', 'fa-bug', '#9b59b6', 4, 'active');

-- Insert Support Teams
INSERT INTO `it_ticket_support_teams` (`id`, `name`, `code`, `description`, `support_level`, `country`, `status`) VALUES
(1, 'IT Support L1', 'IT_L1', 'Level 1 IT Support', 'L1', 'Vietnam', 'active'),
(2, 'IT Support L2', 'IT_L2', 'Level 2 IT Support', 'L2', 'Vietnam', 'active'),
(3, 'Network Team', 'NETWORK_TEAM', 'Network Infrastructure Team', 'L2', 'Vietnam', 'active'),
(4, 'Security Team', 'SECURITY_TEAM', 'Cyber Security Team', 'L3', 'Vietnam', 'active');

-- Insert IT Services for HRM
INSERT INTO `it_ticket_services` (`id`, `service_group_id`, `name`, `code`, `parent_id`, `input_type`, `sort_order`, `status`) VALUES
-- Parent services
(1, 2, 'Attendance', 'HRM_ATTENDANCE', NULL, 'dropdown', 1, 'active'),
(2, 2, 'Leave Management', 'HRM_LEAVE', NULL, 'dropdown', 2, 'active'),
(3, 2, 'Payroll', 'HRM_PAYROLL', NULL, 'dropdown', 3, 'active'),
(4, 2, 'Employee Profile', 'HRM_PROFILE', NULL, 'dropdown', 4, 'active'),

-- Sub-services for Attendance
(5, 2, 'Check-in/Check-out Issue', 'HRM_ATT_CHECKIN', 1, 'radio', 1, 'active'),
(6, 2, 'Timesheet Correction', 'HRM_ATT_TIMESHEET', 1, 'radio', 2, 'active'),
(7, 2, 'Overtime Request', 'HRM_ATT_OVERTIME', 1, 'radio', 3, 'active'),

-- Sub-services for Leave
(8, 2, 'Annual Leave', 'HRM_LEAVE_ANNUAL', 2, 'radio', 1, 'active'),
(9, 2, 'Sick Leave', 'HRM_LEAVE_SICK', 2, 'radio', 2, 'active'),
(10, 2, 'Unpaid Leave', 'HRM_LEAVE_UNPAID', 2, 'radio', 3, 'active'),

-- Sub-services for Payroll
(11, 2, 'Salary Inquiry', 'HRM_PAY_INQUIRY', 3, 'radio', 1, 'active'),
(12, 2, 'Tax Certificate', 'HRM_PAY_TAX', 3, 'radio', 2, 'active'),
(13, 2, 'Bonus Inquiry', 'HRM_PAY_BONUS', 3, 'radio', 3, 'active');

-- Insert IT Services for Network
INSERT INTO `it_ticket_services` (`id`, `service_group_id`, `name`, `code`, `parent_id`, `input_type`, `sort_order`, `status`) VALUES
(20, 1, 'Internet Connection', 'NET_INTERNET', NULL, 'dropdown', 1, 'active'),
(21, 1, 'VPN Access', 'NET_VPN', NULL, 'dropdown', 2, 'active'),
(22, 1, 'WiFi Issue', 'NET_WIFI', NULL, 'dropdown', 3, 'active'),

-- Sub-services for Network
(23, 1, 'No Internet', 'NET_INT_NO_CONN', 20, 'radio', 1, 'active'),
(24, 1, 'Slow Connection', 'NET_INT_SLOW', 20, 'radio', 2, 'active'),
(25, 1, 'Cannot Connect VPN', 'NET_VPN_CONN', 21, 'radio', 1, 'active'),
(26, 1, 'VPN Disconnects', 'NET_VPN_DISC', 21, 'radio', 2, 'active');

-- Insert IT Services for User Computer
INSERT INTO `it_ticket_services` (`id`, `service_group_id`, `name`, `code`, `parent_id`, `input_type`, `sort_order`, `status`) VALUES
(30, 3, 'Hardware Issue', 'UC_HARDWARE', NULL, 'dropdown', 1, 'active'),
(31, 3, 'Software Installation', 'UC_SOFTWARE', NULL, 'dropdown', 2, 'active'),
(32, 3, 'Printer Issue', 'UC_PRINTER', NULL, 'dropdown', 3, 'active'),

-- Sub-services
(33, 3, 'Computer Not Starting', 'UC_HW_NO_START', 30, 'radio', 1, 'active'),
(34, 3, 'Monitor Issue', 'UC_HW_MONITOR', 30, 'radio', 2, 'active'),
(35, 3, 'Keyboard/Mouse', 'UC_HW_INPUT', 30, 'radio', 3, 'active'),
(36, 3, 'Install Office', 'UC_SW_OFFICE', 31, 'radio', 1, 'active'),
(37, 3, 'Install Other Software', 'UC_SW_OTHER', 31, 'radio', 2, 'active');

-- Insert IT Services for Cyber Security
INSERT INTO `it_ticket_services` (`id`, `service_group_id`, `name`, `code`, `parent_id`, `input_type`, `sort_order`, `status`) VALUES
(40, 4, 'Phishing Email', 'SEC_PHISHING', NULL, 'dropdown', 1, 'active'),
(41, 4, 'Malware/Virus', 'SEC_MALWARE', NULL, 'dropdown', 2, 'active'),
(42, 4, 'Account Security', 'SEC_ACCOUNT', NULL, 'dropdown', 3, 'active'),

-- Sub-services
(43, 4, 'Suspicious Email', 'SEC_PHISH_EMAIL', 40, 'radio', 1, 'active'),
(44, 4, 'Clicked Phishing Link', 'SEC_PHISH_CLICK', 40, 'radio', 2, 'active'),
(45, 4, 'Virus Detected', 'SEC_MAL_VIRUS', 41, 'radio', 1, 'active'),
(46, 4, 'Computer Infected', 'SEC_MAL_INFECT', 41, 'radio', 2, 'active'),
(47, 4, 'Password Reset', 'SEC_ACC_PASS', 42, 'radio', 1, 'active'),
(48, 4, 'Account Locked', 'SEC_ACC_LOCK', 42, 'radio', 2, 'active');
