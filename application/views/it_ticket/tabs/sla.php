<div id="tab-sla" class="tab-content active">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div>
                <button id="btnAddSLAPolicy" class="btn btn-primary" disabled
...
<div id="modalSLAPolicy" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary" onclick="SLAManager.savePolicy()">
...
<div id="modalSLAMapping" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary" onclick="SLAMappingManager.saveMapping()">
                <i class="fas fa-save"></i> Save
            </button>
        </div>
    </div>
